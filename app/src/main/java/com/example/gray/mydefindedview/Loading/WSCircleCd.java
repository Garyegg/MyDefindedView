package com.example.gray.mydefindedview.Loading;
...
public class WSCircleCd extends View{
    ...
    public WSCircleCd(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public WSCircleCd(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
